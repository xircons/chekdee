...
// checkout) — who changed it, when, and the old/new value. Still used as a
// type by the admin dashboard's own correction flow (local component state,
// not seeded from here — see admin/page.tsx).
