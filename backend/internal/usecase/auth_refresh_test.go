...
func (f *fakeUserRepo) CompleteRegistration(context.Context, string, string, string, string, *string, *string, *string, *string) (*domain.User, error) {
	return nil, nil
}
...
func (f *fakeUserRepo) Update(context.Context, string, *string, *string, *string, *string, *string, *string, *string, *string) (*domain.User, error) {
	return nil, nil
}
