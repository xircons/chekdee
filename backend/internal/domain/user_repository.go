...
type UserRepository interface {
	...
	// actions with their own audit-log entries. Best-effort audited by the
	// caller (usecase), not transactional — see UpdateRole/Offboard below
	// for why those two are different.
